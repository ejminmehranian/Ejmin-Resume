...
\workEntry{Bepom LLC}{March 2019 - Present}{Software Engineering team member }{• With a team of 4 members, established a food ordering application for both Android and IOS platforms and an admin website for business owners to manage the orders 
\\ • Utilized React, Redux, React Native, NodeJs, MongoDB, Heroku, Git and etc
\\• Application is in the process of being deployed and served to public } {IMG/empty}
\sepspace

\workEntry{Anoush Dance Studio}{Summer 17' \\ \url{http://www.anoushdance.com}}{Software Engineer}{• Established a Java program to create a customer registeration and payment system 
...
\NewPart{Skills}{}
\noindent
{\textbf{Languages}: JavaScript, Nodejs, CSS, HTML, Java, Python, C, C++, GoLang}\\
{\textbf{Frameworks/Libraries}: React, React Native, Redux, Django, Mongoose, Axios, Bootstrap, Java Swing}\\
{\textbf{Other tools}: Git, Jira, Vim, Linux, Bash, Kubernetes, AWS, Heroku, MongoDB, SQL
